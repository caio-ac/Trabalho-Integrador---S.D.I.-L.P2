                            ...
                            <form action="base.php" method="GET">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <select id="faixa2" name="faixa2" step="0.01" class="form-control" ><br>
                                                <option for="preto">Preto</option>
                                                <option for="marrom">Marrom</option>
                                                <option for="vermelho">Vermelho</option>
                                                <option for="laranja">Laranja</option>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <select id="faixa3" name="faixa3" step="0.01" class="form-control" ><br>
                                                <option for="preto">Preto</option>
                                                <option for="marrom">Marrom</option>
                                                <option for="vermelho">Vermelho</option>
                                                <option for="laranja">Laranja</option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <select id="faixa4" name="faixa4" step="0.01" class="form-control" ><br>
                                ...
                                <div class="form-row">
                                    <br><input type="submit" value="Calcular Resistencia do Resistor" class="btn btn-primary col-md-12" id="Enviar"><br>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
                                        <symbol id="exclamation-triangle-fill" viewBox="0 0 16 16">
                                            <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                                        </symbol>
