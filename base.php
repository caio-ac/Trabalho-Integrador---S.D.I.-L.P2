                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="tensaoFonte" name="tensaoFonte" class="form-control" required><br>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="corrente" name="corrente" class="form-control" required><br>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="tensaoLED" name="tensaoLED" class="form-control" required><br>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="nLED" name="nLED" class="form-control" required><br>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <br><input type="submit" value="Calcular Resistor" class="btn btn-primary" id="Enviar">
                            </div>
                            <?php
